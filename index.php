	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2 style="color: black;font-family: monospace;"><b style="color: black;font-size: 80px;">AgroCulture</b></h2>
				<p style="color: black;"><b style="color: black;">Your Product Our Market</b></p>
				<br><br>
				<center>
					<div class="row uniform">
						<div class="6u 12u$(xsmall)">
							<button class="button fit" onclick="document.getElementById('id01').style.display='block'" style="width:auto;color:black;background-color: #f9f9f9;"><b style="color: black;">LOGIN</b></button>
						</div>

						<div class="6u 12u$(xsmall)">
							<button class="button fit" onclick="document.getElementById('id02').style.display='block'" style="width:auto;color:black;background-color: #f9f9f9;"> <b style="color: black;">REGISTER</b></button>
						</div>
					</div>
				</center>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Farm<span>Mangalore</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9999299993</p>
			</div>
		>
		</div>
