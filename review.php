...
<body>
				...
				<section id="main" class="wrapper style1 align-center">
                            ...
                            <center>
                                <div class="row uniform">
                                    <div class="6u 12u$(large)">
                                        <a href="myCart.php?flag=1&pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;width: 150px;height: 50px;" ><span class="glyphicon glyphicon-shopping-cart"><b style="color: white;font-size: 20px;" > AddToCart</b></a>
                                    </div>
                                    <div class="6u 12u$(large)">
                                        <a href="buyNow.php?pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;width: 150px;height: 50px;"><b style="color: white;font-size: 20px;">Buy Now</b></a>
                                    </div>
                                </div>
                            </center>
                        </div>
					...
					<div class="container">
						<h1 style="color:white">Product Reviews</h1>
					<div class="row">
						<?php
