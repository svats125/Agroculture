	...
	<body class>
		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
				<div class="container">
						<h2 style="font-size: 40px;font-family: monospace;">Welcome to digital market</h2>
				...
				<?php
					...
					<?php
						...
						?>
							<div class="col-md-4">
							<section>
							<strong><h2 class="title" style="color:white; font-family: cursive;font-size: 35px;"><?php echo $row['product'].'';?></h2></strong>
							<a href="review.php?pid=<?php echo $row['pid'] ;?>" > <img class="image fit" src="<?php echo $picDestination;?>" height="220px;"  /></a>

							<div style="align: left">
							<blockquote><b style="color:white; font-family: cursive;font-size: 25px;" ><?php echo "Type : ".$row['pcat'].'';?><br><?php echo "Price : ".$row['price'].' /-';?></b><br></blockquote>
