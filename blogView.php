		...
		?>
			...
			<section id="main" class="wrapper">
				<div class="inner">
					...
					?>
					<div class="box">
						<h2 style="color:black;font-size: 40px;font-family: sans-serif;"><?= $row['blogTitle']; ?></h2>
						<blockquote>
							<b style="color: black;font-size: 23px;font-weight: 900;font-family: cursive;"><?= $row['blogContent']; ?></b>
							<p style="color: black;font-weight: 900;">--- <?= $row['blogUser']; ?></p>
							<p style="color: black;font-weight: 900;"><?= $row['blogTime']; ?></p>
						</blockquote>
						...
						<form method="post" action="blogView.php">
							<div class="row">
								<div class="6u 12u$(xsmall)">
									...
									<span  style="color: black;font-weight: 900;"><?= $row['likes']?></span>
								</div>
								<div class="6u 12u$(xsmall)">
									<span class="glyphicon glyphicon-pencil"  style="color: black;font-weight: 900;"></span><b style="color: black;font-weight: 900;"> Comments :</b><b style="color: black;font-weight: 900;"> <?= $numComment ?></b></button>
								</div>
								<div class="12u$">
									<br>
									<textarea name="comment" id="comment" rows="1" placeholder="Write a Comment!" style="color: white;"></textarea>
								</div>
								<div class="12u$">
									<center>
									<br>
